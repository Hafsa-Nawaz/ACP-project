...
import Products from "./pages/products/Products"; // Ensure Products is correctly imported
    ...
    return (
        <div className="app">
            <Router>
                ...
                <Route path="/products" component={Products} exact /> {/* Ensure products route is present */}
